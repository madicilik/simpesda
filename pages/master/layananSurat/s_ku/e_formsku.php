<div class="page-inner" style="color:#eb34e1"><br>
	<div class="page-header" style="color:#eb34e1">
		<h4 class="page-title" style="color:#eb34e1">Surat Keterangan Usaha</h4>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				...
				<div class="card-body">
                    <form action="pages/master/layananSurat/s_ku/e_cetak.php" method="post" target="_blank"> 
                        <div class="row">
                            <div class="col-md-6">
                    ...
                    <script>
                        function isi_otomatis(){
                            ...
                            $.ajax({
                                type:'get',
                                url: 'pages/master/layananSurat/s_ku/proses_sku.php',
                                data: 'nik='+nik,

<div class="page-inner" style="color:#eb34e1"><br>
	<div class="page-header" style="color:#eb34e1">
		<h4 class="page-title" style="color:#eb34e1">Surat Keterangan Ijin Bepergian</h4>
		<ul class="breadcrumbs">
			...
			<li class="nav-item"><a href="#" style="color:#eb34e1">Beranda</a></li>
		</ul>
	</div>
    <?php
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				...
				<div class="card-body">
                    <form action="pages/master/layananSurat/s_kib/e_cetak.php" method="post" target="_blank"> 
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group"> 
                                    ...
                                    <input type="text" class="form-control" id="kep" name="kep"> 
                                </div>
                                <div class="form-group"> 
                    ...
                    <script>
                        function isi_otomatis(){
                            ...
                            $.ajax({
                                type:'get',
                                url: 'pages/master/layananSurat/s_kib/proses_skib.php',
                                data: 'nik='+nik,
                                ...
                                $('#alamat_tujuan')=val(alamat_tujuan);
                                $('#kep')=val(kep);
